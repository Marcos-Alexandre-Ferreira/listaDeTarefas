...
fetch("https://crudcrud.com/api/471f3ffff9dd43328dc462655e554434/tarefas")
...
function remove(id, elementoBotao) {
    ...
    fetch(`https://crudcrud.com/api/471f3ffff9dd43328dc462655e554434/tarefas/${id}`, { method: 'DELETE' });
